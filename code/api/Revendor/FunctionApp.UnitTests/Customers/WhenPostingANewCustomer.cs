...
{
    [TestFixture]
    public class WhenPostingANewCustomer : TenantBaseTests<CreateCustomerFunction, CustomerDto>
    {
        private Mock<ICustomerService> customerService;

        public override CreateCustomerFunction Function { get; set; }
        ...
        protected override void AdditionalSetup()
        {
            ...
            Function = new CreateCustomerFunction(customerService.Object, TokenIssue.Object);
        }
        ...
        public async Task ShouldInvokeCustomerService()
        {
            ...
            customerService.Verify(x => x.CreateNewCustomer(It.Is<CustomerDto>(c =>
