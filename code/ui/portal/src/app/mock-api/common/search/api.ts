...
import { customers } from 'app/mock-api/apps/customers/data';
...
export class SearchMockApi
{
    ...
    private readonly _customers: any[] = customers;
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                const customersResults = cloneDeep(this._customers)
                ...
                // If there are customers results...
                if ( customersResults.length > 0 )
                {
                    // Normalize the results
                    customersResults.forEach((result) => {

                        // Add a link
                        result.link = '/apps/customers/' + result.id;
                    });
